# Generated by Django 2.2 on 2020-06-12 08:57
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='post',
            name='post_category',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='post_api.PostCategory'),
        ),
        migrations.AddField(
            model_name='post',
            name='tag',
            field=models.ManyToManyField(through='post_api.PostTag', to='post_api.Tag'),
        ),
        migrations.CreateModel(
            name='CommentReport',
            fields=[
